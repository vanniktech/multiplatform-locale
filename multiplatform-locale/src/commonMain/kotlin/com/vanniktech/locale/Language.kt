...
enum class Language(
  ...
  KYRGYZ(
    code = "ky",
    officialTerritories = listOf(Country.KYRGYZSTAN),
    otherTerritories = listOf(Country.CHINA, Country.TAJIKISTAN, Country.UZBEKISTAN, Country.AFGHANISTAN),
  ),
  LAO(
    code = "lo",
  ...
  NEPALI(
    ...
    otherTerritories = listOf(Country.BHUTAN, Country.INDIA),
  ),
  NORWEGIAN(
    code = "no",
    officialTerritories = listOf(Country.NORWAY),
