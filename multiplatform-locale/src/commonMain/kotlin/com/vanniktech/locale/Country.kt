...
enum class Country(
  ...
  BONAIRE(code = "BQ", code3 = "BES", callingCodes = listOf("+599"), continents = listOf(Continent.SOUTH_AMERICA)),
  ...
  CURACAO(code = "CW", code3 = "CUW", callingCodes = listOf("+599"), continents = listOf(Continent.SOUTH_AMERICA)),
